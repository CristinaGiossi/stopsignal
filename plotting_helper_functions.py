...
def save_dataframes(firing_rates,reward_q_df, performance, rt_distribution,total_performance, seed):
    ...
    total_performance.to_csv(data_dir+str(seed)+"/"+"total_performance.csv")
...
def extract_relevant_frames(results,seed):
    ...
    print(q_df)   
    #print(performance)
    save_dataframes(firing_rates,q_df, performance, rt_distribution,total_performance, seed)
